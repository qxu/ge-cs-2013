...
public class Tournament
{
	 ...
	 * the next game
	 */
	public final static int maxSteps = 2000;
	/*
	 * Possible maps to use are: map01.tmx map02.tmx map03.tmx
	 */
	public final static String maps[] = {"test01.tmx", "test02.tmx", "test02withkeys.tmx", "test07withkeys.tmx", "test07.1withkeys.tmx", "test07.11withkeys.tmx"};
	/*
	 * This is how many spaces ahead players can see. Acceptable values are 1
	 * through 15.
	 */
	public final static int vision[] = {5};
	/*
