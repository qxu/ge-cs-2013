...
public class ImageDataByteArrayGenerator {
	public static void main(String[] args) throws IOException {
		...
		Image[][] tiles = { { emptyImage, blackImage },
				{ keyImage, lockImage }, { locationImage, exitImage },
				{ questionImage }, };
		BufferedImage spriteSheet = tile(tiles, 2, 4, 16, 16);
		generateAndPrint(spriteSheet, "sprites");
	}

	private static BufferedImage tile(Image[][] tiles, int cols, int rows,
			int tileWidth, int tileHeight) {
		BufferedImage buf = new BufferedImage(cols * tileWidth, rows
